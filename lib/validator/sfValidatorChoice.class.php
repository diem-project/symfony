...
class sfValidatorChoice extends sfValidatorBase
{
	...
	/**
	 * @see https://github.com/antitoxic/symfony/commit/de4139af6b088827884c911b260c144ff2f4ccb2
	 * 
	 * (non-PHPdoc)
	...
	{
		return parent::isEmpty($value) || (is_array($value) && count($value)==1 && $this->isEmpty($value[0]));
	}
}
